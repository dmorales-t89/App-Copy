    ...
    <div className={cn("w-full", className)} {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans font-bold text-gray-900 text-base">
            Upload Image
          </p>
          <p className="relative z-20 font-sans font-normal text-gray-700 text-base mt-2">
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="text-base text-gray-900 truncate max-w-xs"
                    >
                      {file.name}
                    </motion.p>
                    <motion.p
                  ...
                  <div className="flex text-sm md:flex-row flex-col items-start md:items-center w-full mt-2 justify-between text-gray-700">
                    <motion.p
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      layout
            ...
            {!files.length && (
              ...
              >
                {isDragActive ? (
                  ...
                  >
                    Drop it
                    <IconUpload className="h-4 w-4 text-gray-700" />
                  </motion.p>
                ) : (
                  <IconUpload className="h-4 w-4 text-gray-700" />
                )}
          ...
          return (
            <div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ? "bg-white/50"
                  : "bg-white/50 shadow-[0px_0px_1px_3px_rgba(255,255,255,0.5)_inset]"
              }`}
            />
          );
        })
